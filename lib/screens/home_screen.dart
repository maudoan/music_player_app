...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        actions: [
          Consumer<MusicProvider>(
            builder: (context, musicProvider, child) {
              return IconButton(
                onPressed: musicProvider.tabs.isEmpty ? null : () => _showSortMenu(context),
                icon: const Icon(Icons.sort, color: Colors.white),
                tooltip: 'Sắp xếp bài hát',
              );
            },
          ),
          IconButton(
      ...
      body: Consumer<MusicProvider>(
        builder: (context, musicProvider, child) {
          return _buildMainContent(context, musicProvider);
        },
      ),
  ...
  Widget _buildMainContent(BuildContext context, MusicProvider musicProvider) {
